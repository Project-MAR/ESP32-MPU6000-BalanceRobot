...
// MPU-6000 I2C address is 0x68 if AD = 0, otherwise 0x69
#define Addr 0x68
...
void setup()
{
  ...
  /*
  Serial.print("AccStepCoeff: ");
  printDouble(AccStepCoeff, 10000000);
  Serial.print("GyroStepCoeff: ");
  printDouble(GyroStepCoeff, 10000000);
  while(1){}
  */
  delay(500);
}
